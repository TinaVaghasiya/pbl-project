...
# Use simple detector instead of MediaPipe
from simple_detector import SimpleGestureDetector

app = Flask(__name__)
CORS(app)

print("Initializing simple gesture detector...")
...
def process_video():
    try:
        ...
        if results.multi_hand_landmarks:
            ...
            features = detector.extract_features(results.multi_hand_landmarks[0])
